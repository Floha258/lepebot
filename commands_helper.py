...
class PrivmsgCommand:
    ...
    def __init__(self, name, func, channel_cooldown=0, user_cooldown=0, mod_only=False, broadcaster_only=False,
                 enabled=True):
        """
        Init a new Command
        Params:
...
class CommandsHelper:
    ...
    def add_privmsg_command(self, name, func, channel_cooldown=0, user_cooldown=0, mod_only=False,
        ...
        """
        self._add_privmsg_command(
            PrivmsgCommand(name, func, channel_cooldown, user_cooldown, mod_only, broadcaster_only))
